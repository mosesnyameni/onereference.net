...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container px-5">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item"><a class="nav-link" href="agent_home.php">Home</a></li>
            <li class="nav-item"><a class="nav-link" href="agent_home.php">Resources and Support</a></li>
            <li class="nav-item"><a class="nav-link" href="agent_home.php">Services</a></li>
