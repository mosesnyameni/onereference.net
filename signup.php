...
<html lang="en">
    ...
    <body>
        <!-- Responsive navbar-->
        <?php include_once("services/signup_service.php"); ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="card-header"><h4> Create Profile </h4></div>
                                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="on">                                   
                                    <!-- <form method="post" > -->
                                    <div class="card-body">
                                        <div class="input-group">
                                            <p class="card-text" id="passerror" <?php echo (isset($passError))?'visible':'hidden'; ?>  style="color:red"> <?php
                                                if (isset($passError)) {
                                                    echo $passError;
                                                }
                                                ?></p>
                                            <p class="card-text" id="emailerror" <?php echo (isset($emailerror))?'visible':'hidden'; ?> style="color:red"> <?php
                                                if (isset($emailError)) {
                                                    echo $emailError;
                                                }
                                                ?></p> 
                                            <p class="card-text" id="error_msg" <?php echo (isset($error_msg))?'visible':'hidden'; ?> style="color:red"> <?php
                                                if (isset($error_msg)) {
                                                    echo $error_msg;
                                                }
                                                ?></p> 
                                            <p class="card-text" id="conf_pass_Error" <?php echo (isset($conf_pass_Error))?'visible':'hidden'; ?> style="color:red"> <?php
                                                if (isset($conf_pass_Error)) {
