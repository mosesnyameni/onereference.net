...
CREATE TABLE `users` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT 3 COMMENT '1 = Agent,2 = Candidate, 3 = Referee',
  `date_created` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `candidate_referee_link`
--

CREATE TABLE `candidate_referee_link` (
  `id` int(30) NOT NULL,
  `user_id` int(30) NOT NULL,
  `candidate_id` int(30) NOT NULL,
  `referee_id` int(30) NOT NULL,
  `date_created` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
--
...
--
-- Indexes for table `agent_candidate_link`
--
ALTER TABLE `candidate_referee_link`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `candidate_referee_link`
--
ALTER TABLE `candidate_referee_link`
