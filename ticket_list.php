					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_ticket" href="./home.php?page=view_ticket&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">View</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item" href="./home.php?page=edit_ticket&id=<?php echo $row['id'] ?>">Edit</a>
		                      <div class="dropdown-divider"></div>
