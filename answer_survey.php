			...
			<div class="card card-outline card-success">
				...
				<div class="card-footer border-top border-success">
					<div class="d-flex w-100 justify-content-center">
						...
						<button class="btn btn-sm btn-flat bg-gradient-secondary mx-1" type="button" onclick="location.href = 'home.php?page=survey_widget'">Cancel</button>
					</div>
				</div>
			</div>
		</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.href = 'home.php?page=survey_widget'
					},2000)
				}
			}
		})
